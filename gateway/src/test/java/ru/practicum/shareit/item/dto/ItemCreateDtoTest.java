...
class ItemCreateDtoTest {
    ...
    @Test
    void allCorrect() {
        final ItemCreateDto itemCreateDto = new ItemCreateDto(CORRECT_NAME, CORRECT_DESCRIPTION, CORRECT_AVAILABLE, CORRECT_REQUEST_ID);
    ...
    void notCorrectNameShouldBeNull() {
        final ItemCreateDto itemCreateDto = new ItemCreateDto(null, CORRECT_DESCRIPTION, CORRECT_AVAILABLE, CORRECT_REQUEST_ID);
        final Set<ConstraintViolation<ItemCreateDto>> violations = validator.validate(itemCreateDto);
    ...
    void notCorrectNameShouldBeBlank() {
        final ItemCreateDto itemCreateDto = new ItemCreateDto(" ", CORRECT_DESCRIPTION, CORRECT_AVAILABLE, CORRECT_REQUEST_ID);
        final Set<ConstraintViolation<ItemCreateDto>> violations = validator.validate(itemCreateDto);
    ...
    void notCorrectNameShouldBeLossMinLength() {
        ...
        final ItemCreateDto itemCreateDto = new ItemCreateDto(notCorrectName, CORRECT_DESCRIPTION, CORRECT_AVAILABLE, CORRECT_REQUEST_ID);
        final Set<ConstraintViolation<ItemCreateDto>> violations = validator.validate(itemCreateDto);
    ...
    void notCorrectDescriptionShouldBeNull() {
        final ItemCreateDto itemCreateDto = new ItemCreateDto(CORRECT_NAME, null, CORRECT_AVAILABLE, CORRECT_REQUEST_ID);
        final Set<ConstraintViolation<ItemCreateDto>> violations = validator.validate(itemCreateDto);
    ...
    void notCorrectDescriptionShouldBeBlank() {
        final ItemCreateDto itemCreateDto = new ItemCreateDto(CORRECT_NAME, " ", CORRECT_AVAILABLE, CORRECT_REQUEST_ID);
        final Set<ConstraintViolation<ItemCreateDto>> violations = validator.validate(itemCreateDto);
    ...
    void notCorrectDescriptionShouldBeLossMinLength() {
        ...
        final ItemCreateDto itemCreateDto = new ItemCreateDto(CORRECT_NAME, notCorrectDescription, CORRECT_AVAILABLE, CORRECT_REQUEST_ID);
        final Set<ConstraintViolation<ItemCreateDto>> violations = validator.validate(itemCreateDto);
    ...
    void notCorrectAvailableShouldBeNull() {
        final ItemCreateDto itemCreateDto = new ItemCreateDto(CORRECT_NAME, CORRECT_DESCRIPTION, null, CORRECT_REQUEST_ID);
        final Set<ConstraintViolation<ItemCreateDto>> violations = validator.validate(itemCreateDto);
